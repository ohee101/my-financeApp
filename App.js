      ...
      <View style={{ paddingTop: 50, paddingHorizontal: 14 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <View>
            ...
            <Text style={{ fontSize: 26, color: '#fff', opacity: 0.6 }}>Heisenberg</Text>
          </View>
          <View>
            <Image
